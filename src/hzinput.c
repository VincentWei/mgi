...
static BITMAP bmp;    // the bmp of the IME control button
...
static BOOL hz_input_init(void)
{
    ...
    if (LoadBitmapFromFile (HDC_SCREEN, sg_bmpIME, "./shurufa.bmp")) {
...
static void InitIMEWinCreateInfo (PMAINWINCREATE pCreateInfo)
{
    ...
    pCreateInfo->iBkColor = PIXEL_darkgray;//GetWindowElementColor (BKC_CONTROL_DEF); 
